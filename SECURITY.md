...
- **Local execution:** SSH uses argument arrays, strict host-key checking and no shell interpolation. Text CLI adapters disable tools where supported. Image adapters now remove Grok file-reading permission and disable Codex shell/plugins. Installed CLI and MCP software remains trusted code.
